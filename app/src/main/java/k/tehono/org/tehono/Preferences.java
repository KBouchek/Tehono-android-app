...
/*
Preferences yourPrefrence = Preferences.getInstance(context);
String value = yourPreference.getStringData(YOUR_KEY);
yourPrefrence.saveStringData(YOUR_KEY,YOUR_VALUE);
